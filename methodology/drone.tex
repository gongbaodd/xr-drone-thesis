...
In this implementation, input shaping combines proportional ($p$) and exponential ($e$) components to map the raw joystick input ($u$) to a target angular rate ($\tau$), as shown in Equation~\ref{eq:mapping}.
