...
\begin{table}[h]
\centering
\caption{Software Engine Overview}\label{table:xr_engine}
...
Unity is frequently used in research due to its flexible configuration, extensive plugin ecosystem, and ease of rapid prototyping. Thus, it is often used in various experiments \parencite{shatokhin_extended_2025}.
