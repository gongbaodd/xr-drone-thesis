...
% \subsection{Results}
The DBR process consisted of eleven iterative design cycles. One preliminary exploratory cycle investigated the feasibility of implementing drone physics in a WebXR environment. Five cycles focused on refining the XR interaction system through successive prototyping and evaluation. Four cycles were dedicated to the design and training of the human-AI Collaboration (HAC) agent. One final cycle integrated both components into a unified training system. Each iteration informed subsequent refinements in both system behavior and interaction design.
