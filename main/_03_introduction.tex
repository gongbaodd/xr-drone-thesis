...
This study uses a design-based research (DBR) approach. It applies agile development practices and iterative prototyping to build an XR FPV quadcopter simulator, including physics simulation, human-AI collaboration (PID control and reinforcement learning), and interaction design.