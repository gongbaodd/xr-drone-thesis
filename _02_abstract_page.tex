...
\noindent
This study is structured around three primary objectives: (1) the simulation of FPV quadcopter flight physics. (2) the design of a human AI collaboration framework (3) the interaction instruments for a high-fidelity XR prototyping. In particular PID and RL (Reinforcement Learning) are used in the co-training AI, and Geographic Information System (GIS) data integrated to support the environmental representation.
