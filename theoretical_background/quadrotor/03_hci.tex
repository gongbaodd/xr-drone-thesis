...
\begin{table}[H]
\caption{Comparison of Transmitter Control Modes, V stands for vertical, H stands for horizontal}\label{table:modes}
\centering
\begin{tabular}{lllll}
\toprule
...
\begin{figure}[H]
    \caption{Mode 2 control system, Top left: throttle; top right: pitch; bottom left: yaw; bottom right: roll.}\label{fig:mode2}
    \centering
    \includegraphics[width=1\linewidth]{img/drone.png}
\end{figure}
...
\begin{figure}[H]
    \caption{The FPV goggles and its OSD}\label{fig:goggles}
    \centering
