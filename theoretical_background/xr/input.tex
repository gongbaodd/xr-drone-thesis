...
The hardware layout of the Meta Quest 3 Touch Plus controllers is illustrated in \cref{fig:control}, while the functional mapping of each input component is summarized in \cref{table:touchPlus}.
